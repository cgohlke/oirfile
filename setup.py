...
"""Oirfile package Setuptools script."""
...
with open('oirfile/oirfile.py', encoding='utf-8') as fh:
    code = fh.read()
...
setup(
    ...
    project_urls={
        'Bug Tracker': 'https://github.com/cgohlke/oirfile/issues',
        'Source Code': 'https://github.com/cgohlke/oirfile',
        # 'Documentation': 'https://',
    },
    packages=['oirfile'],
    package_data={'oirfile': ['py.typed']},
    entry_points={'console_scripts': ['oirfile = oirfile.oirfile:main']},
